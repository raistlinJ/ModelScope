...
PALETTES: dict[ThemeName, dict[str, str]] = {
    "dark": {
        ...
        "on_error": "#ffffff",
        "info": "#56b6c2", "command": "#e879f9", "prompt": "#4ade80",
        "shadow": "rgba(0,0,0,0.28)", "shadow_strong": "rgba(0,0,0,0.62)",
        "terminal_bg": "#0d1117",
    ...
    "light": {
        ...
        # A dialog's white card sits on an almost-white page, so the scrim is
        # the only thing separating them; 0.36 left them 2.3:1 apart.
        "overlay": "rgba(31,35,40,0.55)",
        "border": "#d0d7de", "border_subtle": "rgba(208,215,222,0.92)",
        # Elevated surfaces (menus, dialogs, tooltips) need an edge that clears
        # the 3:1 non-text minimum against both the card and the page.
        "border_strong": "#878f99",
        ...
        "warn": "#8a5b00", "warn_dim": "rgba(154,103,0,0.12)",
        "error": "#c11c27", "error_dim": "rgba(207,34,46,0.10)",
        "on_error": "#ffffff",
        "info": "#0969da", "command": "#7333d4", "prompt": "#15682d",
        "shadow": "rgba(31,35,40,0.10)", "shadow_strong": "rgba(31,35,40,0.30)",
        "terminal_bg": "#fbfcfd",
...
def css_tokens(theme: ThemeName) -> str:
    ...
    :root {{
        ...
        --border-strong:{values['border_strong']};
        ...
        --shadow:{values['shadow']}; --shadow-strong:{values['shadow_strong']};
        --terminal-bg:{values['terminal_bg']};
